...
namespace Li.Controls.ImageEditors
{
    ...
    /// 旋转图片类
    /// </summary>
    public class RotateImageFilter:IImageFilter
    {
        private string _name = "旋转";
        public string Name
        {
            get
            {
        ...
        /// 旋转
        /// </summary>
        /// <param name="angle">旋转度数：逆时针为正，顺时针为负</param>
        public RotateImageFilter(float angle)//度数
        {
            _angle = angle;
        }
