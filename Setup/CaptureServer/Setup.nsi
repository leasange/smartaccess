...
!define PRODUCT_NAME "SmartAcCaptureService"  ;应用程序名称
!define PRODUCT_SERIES "SMTCS1000"
!define PRODUCT_GUID "{946BEA6E-FA24-4793-9A87-1A887EB1F6AE}" ;应用程序编号
!define COMPANY_NAME "SmartProducts"  ;公司名称
!define PRODUCT_ALIAS_NAME "智能门禁系统抓拍服务端(${PRODUCT_SERIES})" ;//应用系统别名
!define PRODUCT_EXE "SmartAcCaptureService.exe" ;应用程序exe名称
