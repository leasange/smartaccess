...
namespace Maticsoft.DAL
{
	...
	public partial class SMT_ORG_INFO
	{
		...
		public bool Exists(decimal ID)
		{
			...
			strSql.Append("select count(1) from SMT_ORG_INFO");
		...
		public bool Delete(decimal ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SMT_ORG_INFO ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Decimal)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,PAR_ID,ORG_CODE,ORG_NAME,ORDER_VALUE ");
			strSql.Append(" FROM SMT_ORG_INFO ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,PAR_ID,ORG_CODE,ORG_NAME,ORDER_VALUE ");
			strSql.Append(" FROM SMT_ORG_INFO ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SMT_ORG_INFO T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SMT_ORG_INFO";
