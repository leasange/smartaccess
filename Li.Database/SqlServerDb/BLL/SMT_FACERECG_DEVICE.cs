...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.SMT_FACERECG_DEVICE dal=new Maticsoft.DAL.SMT_FACERECG_DEVICE();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.SMT_FACERECG_DEVICE GetModelByCache(decimal ID)
		{
			
			string CacheKey = "SMT_FACERECG_DEVICEModel-" + ID;
			...
			return (Maticsoft.Model.SMT_FACERECG_DEVICE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_FACERECG_DEVICE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_FACERECG_DEVICE> DataTableToList(DataTable dt)
		{
