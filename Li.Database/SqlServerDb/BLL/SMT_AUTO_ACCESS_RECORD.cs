...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.SMT_AUTO_ACCESS_RECORD dal=new Maticsoft.DAL.SMT_AUTO_ACCESS_RECORD();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.SMT_AUTO_ACCESS_RECORD GetModelByCache(decimal ID)
		{
			
			string CacheKey = "SMT_AUTO_ACCESS_RECORDModel-" + ID;
			...
			return (Maticsoft.Model.SMT_AUTO_ACCESS_RECORD)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_AUTO_ACCESS_RECORD> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_AUTO_ACCESS_RECORD> DataTableToList(DataTable dt)
		{
