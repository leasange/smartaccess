...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.SMT_STAFF_INFO dal=new Maticsoft.DAL.SMT_STAFF_INFO();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.SMT_STAFF_INFO GetModelByCache(decimal ID)
		{
			
			string CacheKey = "SMT_STAFF_INFOModel-" + ID;
			...
			return (Maticsoft.Model.SMT_STAFF_INFO)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_STAFF_INFO> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_STAFF_INFO> DataTableToList(DataTable dt)
		{
