...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.SMT_SUPER_PWD dal=new Maticsoft.DAL.SMT_SUPER_PWD();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.SMT_SUPER_PWD GetModelByCache(decimal ID)
		{
			
			string CacheKey = "SMT_SUPER_PWDModel-" + ID;
			...
			return (Maticsoft.Model.SMT_SUPER_PWD)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_SUPER_PWD> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_SUPER_PWD> DataTableToList(DataTable dt)
		{
