...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.SMT_ATTEN_REPORT dal=new Maticsoft.DAL.SMT_ATTEN_REPORT();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.SMT_ATTEN_REPORT GetModelByCache(decimal ID)
		{
			
			string CacheKey = "SMT_ATTEN_REPORTModel-" + ID;
			...
			return (Maticsoft.Model.SMT_ATTEN_REPORT)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.SMT_ATTEN_REPORT> DataTableToList(DataTable dt)
		{
