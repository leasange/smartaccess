...
namespace Maticsoft.DAL
{
	...
	public partial class SMT_AUTO_ACCESS
	{
		...
		public bool Exists(string ACC_APP_ID,decimal ACC_DOOR_ID,DateTime ACC_START_TIME,decimal ID)
		{
			...
			strSql.Append("select count(1) from SMT_AUTO_ACCESS");
			strSql.Append(" where ACC_APP_ID=@ACC_APP_ID and ACC_DOOR_ID=@ACC_DOOR_ID and ACC_START_TIME=@ACC_START_TIME and ID=@ID ");
			...
			parameters[0].Value = ACC_APP_ID;
			parameters[1].Value = ACC_DOOR_ID;
			parameters[2].Value = ACC_START_TIME;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SMT_AUTO_ACCESS(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SMT_AUTO_ACCESS set ");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@ACC_START_TIME", SqlDbType.DateTime)};
			parameters[0].Value = model.ACC_FROM_SYS;
			parameters[1].Value = model.ACC_STAFF_ID;
			parameters[2].Value = model.ACC_END_TIME;
			parameters[3].Value = model.ACC_ADD_TIME;
			parameters[4].Value = model.ACC_STATE_TIME;
			parameters[5].Value = model.ACC_STATE;
			parameters[6].Value = model.ID;
			parameters[7].Value = model.ACC_APP_ID;
			parameters[8].Value = model.ACC_DOOR_ID;
			parameters[9].Value = model.ACC_START_TIME;
		...
		public bool Delete(decimal ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SMT_AUTO_ACCESS ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
		...
		public Maticsoft.Model.SMT_AUTO_ACCESS GetModel(decimal ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 ID,ACC_FROM_SYS,ACC_APP_ID,ACC_APP_NAME,ACC_STAFF_ID,ACC_DOOR_ID,ACC_START_TIME,ACC_END_TIME,ACC_ADD_TIME,ACC_STATE_TIME,ACC_STATE from SMT_AUTO_ACCESS ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Decimal)
			};
			...
			Maticsoft.Model.SMT_AUTO_ACCESS model=new Maticsoft.Model.SMT_AUTO_ACCESS();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.SMT_AUTO_ACCESS DataRowToModel(DataRow row)
		{
			Maticsoft.Model.SMT_AUTO_ACCESS model=new Maticsoft.Model.SMT_AUTO_ACCESS();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM SMT_AUTO_ACCESS ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SMT_AUTO_ACCESS T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SMT_AUTO_ACCESS";
