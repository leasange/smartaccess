...
namespace Maticsoft.DAL
{
	...
	public partial class IMS_FACE_BLACKLIST
	{
		...
		public bool Exists(decimal ID)
		{
			...
			strSql.Append("select count(1) from IMS_FACE_BLACKLIST");
		...
		public bool Delete(decimal ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from IMS_FACE_BLACKLIST ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Decimal)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,Sex,FacePic,Description ");
			strSql.Append(" FROM IMS_FACE_BLACKLIST ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Name,Sex,FacePic,Description ");
			strSql.Append(" FROM IMS_FACE_BLACKLIST ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from IMS_FACE_BLACKLIST T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "IMS_FACE_BLACKLIST";
