...
namespace Maticsoft.DAL
{
	...
	public partial class SMT_CAMERA_INFO
	{
		...
		public bool Exists(decimal ID)
		{
			...
			strSql.Append("select count(1) from SMT_CAMERA_INFO");
		...
		public bool Delete(decimal ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SMT_CAMERA_INFO ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Decimal)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,CAMERA_NAME,CAMERA_IP,CAMERA_PORT,CAMERA_CAP_PORT,CAMERA_USER,CAMERA_PWD,CAMERA_MODEL,CAMERA_CAP_TYPE ");
			strSql.Append(" FROM SMT_CAMERA_INFO ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,CAMERA_NAME,CAMERA_IP,CAMERA_PORT,CAMERA_CAP_PORT,CAMERA_USER,CAMERA_PWD,CAMERA_MODEL,CAMERA_CAP_TYPE ");
			strSql.Append(" FROM SMT_CAMERA_INFO ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SMT_CAMERA_INFO T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SMT_CAMERA_INFO";
