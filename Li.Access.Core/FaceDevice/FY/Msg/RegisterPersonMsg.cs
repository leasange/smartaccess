...
{
    public class RegisterPersonMsg: BaseMsgWithId
    {
        public string personInfoCount;// 注册人员信息条数 string 8 Y 建议单次下发1 条
        public List<PersonInfo> personInfoData;// 注册人员信息数组 string 不限 Y 由personInfoCount个注册人员信息组成的数组，注册人员信息定义如下
    }
    public class PersonInfo
    {
        public string operateType; //操作类型 string 8 Y 如：0：表示添加人员 1：表示修改人员 2：表示删除人员 3：表示删除所有
